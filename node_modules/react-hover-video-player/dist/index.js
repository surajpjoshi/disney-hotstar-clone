...
var HoverVideoPlayer = function (_a) {
    ...
    var formattedVideoSources = React.useMemo(function () { return formatVideoSrc(videoSrc); }, [
        videoSrc,
    ]);
    var formattedVideoCaptions = React.useMemo(function () { return formatVideoCaptions(videoCaptions); }, [videoCaptions]);
    return (React__default['default'].createElement("div", { "data-testid": "hover-video-player-container", ref: containerRef, className: className, style: __assign({ position: 'relative' }, style) },
        ...
        React__default['default'].createElement("video", { loop: loop, playsInline: true, preload: preload, crossOrigin: crossOrigin, ref: videoRef, style: __assign(__assign(__assign({}, videoSizingStyles[sizingMode]), { objectFit: 'cover' }), videoStyle), controls: controls, controlsList: controlsList, className: videoClassName, id: videoId, onError: function () {
            ...
            formattedVideoCaptions.map(function (_a) {
                ...
                return (React__default['default'].createElement("track", { key: src, kind: "captions", src: src, srcLang: srcLang, label: label, default: isDefault }));
            }))));
};
